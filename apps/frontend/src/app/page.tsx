  ...
  return (
    <div className="space-y-5 lg:pl-0 md:pl-12 lg:w-7/9 mx-auto">
      ...
      <Text variant="md">
        ...
        apríl ár hvert. Skatturinn birtir nákvæma dagsetningu ár hvert á
        skatturinn.is.
      </Text>
      ...
      <ul className="space-y-4">
        <li className="flex items-center">
          <span className="border-red-500 border-4 rounded-full size-1 mr-4 flex-shrink-0"></span>
          <Text variant="md">Skoðað sjálfvirkt útfyllt gögn</Text>
        </li>
        <li className="flex items-center">
          <span className="border-red-500 border-4 rounded-full size-1 mr-4 flex-shrink-0"></span>
      ...
      <div className="bg-blue-100 p-8 rounded-[8px] flex gap-4 items-center my-12">
        <Text variant="h3" className="text-blue-600">
          Skila inn skattframtalið þitt
        </Text>
        <Button size="lg" className="ml-auto">
          Skila inn <SvgOpenOutline />
        </Button>
      </div>
