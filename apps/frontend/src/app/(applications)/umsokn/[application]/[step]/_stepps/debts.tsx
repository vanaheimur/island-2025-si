...
export default function Debts() {
  return (
    <div className="flex flex-col gap-20">
      <div>
        <Text variant="h2" className="mb-4">5.1 - Vaxtagjöld</Text>
      ...
      <div>
        <Text variant="h2" className="mb-4">5.2 - Sala fasteigna</Text>
        <Text variant="sm" className="mb-4">
      ...
      <div>
        <Text variant="h2" className="mb-4">5.3 - Aðrar skuldir og vaxtagjöld</Text>
        <Text variant="sm" className="mb-4">Allar aðrar skuldir og vaxtagjöld</Text>
      </div>

      <div>
        <Text variant="h2" className="mb-4">5.4 - Heildarskuldir</Text>
        <Text variant="sm" className="mb-4">
